...
export async function sendWhatsAppConsentConfirmationEmail(studentEmail, studentName, courseName, conditionsUrl, conditionsVersion, acceptedAt, whatsappLink) {
  try {
